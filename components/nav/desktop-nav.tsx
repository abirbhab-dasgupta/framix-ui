                                        ...
                                        return (
                                            <Link
                                                ...
                                                className={cn(
                                                    ...
                                                    item.isComingSoon
                                                        ...
                                                        : isActive
                                                            ? item.isLab
                                                                ? "bg-purple-500/10 text-blue-700 dark:text-purple-300"
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {item.title}
                                                    {item.isNew && !isActive && (
                                                        <span className="rounded-lg inline-flex items-center px-2 py-0.5 text-[9px] tracking-wide font-medium uppercase bg-linear-to-r from-blue-400/5 via-blue-500/5 to-blue-500/5 text-blue-600 dark:text-blue-400 ring-1 ring-blue-500/20 dark:ring-blue-400/20 shadow-[0_0_10px_-3px_rgba(16,185,129,0.15)] dark:shadow-[0_0_10px_-3px_rgba(16,185,129,0.2)]">
                                                            new
                                                        </span>
                                                    )}
