...
```bash tab="npx"
npx shadcn@latest add https://framixui.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://framixui.vercel.app/r/card-05.json -c ./apps/www
```
